...
Namespace GroupDocs.AssemblyExamples
    Module Module1
        ...
        Sub Main()
            ...
            'Generate a Bulleted List report in spreadsheet format
            GenerateReport.GenerateBulletedList("spreadsheet", False, False, False)

            'Generate a Bulleted List report in presentation format
            GenerateReport.GenerateBulletedList("presentation", False, False, False)
            '#End Region
            ...
            'GenerateReport.GenerateCommonList("document", False, False, False)
            ...
            GenerateReport.GenerateInParagraphList("spreadsheet", False, False, False)

            'Generate a In-Paragraph List Report in presentation format
            GenerateReport.GenerateInParagraphList("presentation", False, False, False)
            '#End Region
            ...
            GenerateReport.GenerateInTableListWithAlternateContent("spreadsheet", False, False, False)

            'Generate a In-Table List with Alternate Content Report in presentation format
            GenerateReport.GenerateInTableListWithAlternateContent("presentation", False, False, False)
            '#End Region
            ...
            GenerateReport.GenerateInTableListWithFilteringGroupingAndOrdering("spreadsheet", False, False, False)

            'Generate a In-Table List with Filtering, Grouping, and Ordering Report in presentation format
            GenerateReport.GenerateInTableListWithFilteringGroupingAndOrdering("presentation", False, False, False)
            '#End Region
            ...
            GenerateReport.GenerateInTableListWithHighlightedRows("spreadsheet", False, False, False)

            'Generate a In-Table List with Highlighted Rows Report in presentation format
            GenerateReport.GenerateInTableListWithHighlightedRows("presentation", False, False, False)
            '#End Region
            ...
            GenerateReport.GenerateInTableList("spreadsheet", False, False, False)

            'Generate a In-Table List Report in presentation format
            GenerateReport.GenerateInTableList("presentation", False, False, False)
            '#End Region
            ...
            GenerateReport.GenerateInTableMasterDetail("spreadsheet", False, False, False)

            'Generate a In-Table Master-Detail Report in presentation format
            GenerateReport.GenerateInTableMasterDetail("presentation", False, False, False)
            '#End Region
            ...
            GenerateReport.GenerateMulticoloredNumberedList("spreadsheet", False, False, False)

            'Generate a Multicolored Numbered List Report in presentation format
            GenerateReport.GenerateMulticoloredNumberedList("presentation", False, False, False)
            '#End Region
            ...
            GenerateReport.GenerateNumberedList("spreadsheet", False, False, False)

            'Generate a Numbered List Report in presentation format
            GenerateReport.GenerateNumberedList("presentation", False, False, False)
            '#End Region
            ...
            'GenerateReport.GenerateSingleRow("spreadsheet", False, False, False)
