...
Namespace GroupDocs.AssemblyExamples
    Module Module1
        ...
        Sub Main()
            ...
            GenerateReport.GenerateBulletedList("document", False, False, True)
            ...
            GenerateReport.GenerateChartWithFilteringGroupingAndOrdering("presentation", False, False, True)
            '#End Region

            '#Region "Generating Common List Report"
            'Generate a Common List Report in document processing format
            GenerateReport.GenerateCommonList("document", False, False, True)

            'Generate a Common List Report in spreadsheet format
            GenerateReport.GenerateCommonList("spreadsheet", False, False, True)

            'Generate a Common List Report in presentation format
            GenerateReport.GenerateCommonList("presentation", False, False, True)
            '#End Region

            '#Region "Generating Common Master-Detail Report"
            'Generate a Common Master-Detail Report in document processing format
            GenerateReport.GenerateCommonMasterDetail("document", False, False, True)

            'Generate a Common Master-Detail Report in spreadsheet format
            GenerateReport.GenerateCommonMasterDetail("spreadsheet", False, False, True)

            'Generate a Common Master-Detail Report in presentation format
            GenerateReport.GenerateCommonMasterDetail("presentation", False, False, True)
            '#End Region

            '#Region "Generating In-Paragraph List Report"
            'Generate a In-Paragraph List Report in document processing format
            GenerateReport.GenerateInParagraphList("document", False, False, True)
            ...
            GenerateReport.GenerateInParagraphList("presentation", False, False, True)
            '#End Region
            ...
            GenerateReport.GenerateInTableListWithAlternateContent("document", False, False, True)
            ...
            GenerateReport.GenerateInTableListWithFilteringGroupingAndOrdering("document", False, False, True)
            ...
            GenerateReport.GenerateInTableListWithHighlightedRows("document", False, False, True)
            ...
            GenerateReport.GenerateInTableList("document", False, False, True)
            ...
            GenerateReport.GenerateInTableMasterDetail("document", False, False, True)
            ...
            GenerateReport.GenerateMulticoloredNumberedList("document", False, False, True)
            ...
            GenerateReport.GenerateNumberedList("document", False, False, True)
            ...
            GenerateReport.GeneratePieChart("document", False, False, True)
            '
            'Generate a Pie Chart Report in spreadsheet format
            GenerateReport.GeneratePieChart("spreadsheet", False, False, True)

            'Generate a Pie Chart Report in presentation format
            GenerateReport.GeneratePieChart("presentation", False, False, True)
            '#End Region

            '#Region "Generating Scatter Chart Report"
            'Generate a Scatter Chart Report in document processing format
            GenerateReport.GenerateScatterChart("document", False, False, True)

            'Generate a Scatter Chart Report in spreadsheet format
            GenerateReport.GenerateScatterChart("spreadsheet", False, False, True)

            'Generate a Scatter Chart Report in presentation format
            GenerateReport.GenerateScatterChart("presentation", False, False, True)
            '#End Region

            '#Region "Generating Single Row Report"
            'Generate a Single Row Report in document processing format
            GenerateReport.GenerateSingleRow("document", False, False, True)
            ...
            'GenerateReport.GenerateSingleRow("presentation", False, False, True)
            '#End Region
