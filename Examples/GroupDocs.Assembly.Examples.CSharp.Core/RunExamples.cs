...
namespace GroupDocs.Assembly.Examples.CSharp.Core
{
    ...
    internal class RunExamples
    {
        ...
        {
            // Get .NET Core version dynamically
            string frameworkVersion = GetCoreVersion();
        ...
        private static string GetCoreVersion()
        {
            ...
            {              
                ...
                return $".NET Core {version.Major}.{version.Minor}.{version.Build}";
            }
        }
    }
}
