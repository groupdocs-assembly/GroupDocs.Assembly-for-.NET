				...
				case "document":
					if (isDatabase)
					{
						...
						try
						{
							...
							assembler.AssembleDocument(CommonUtilities.GetSourceDocument(strDocumentTemplate), CommonUtilities.SetDestinationDocument(strDocumentReport), new DataSourceInfo(DataLayer.GetSingleCustomerDataDB(), "customer"));
						}
						catch (Exception ex)
						{
							Console.WriteLine(ex.Message);
					...
					else if (isDataSet)
					{
						...
						try
						{
							...
							DocumentAssembler assembler = new DocumentAssembler();
							//Call AssembleDocument to generate Single Row Report in open document format
							assembler.AssembleDocument(CommonUtilities.GetSourceDocument(strDocumentTemplate), CommonUtilities.SetDestinationDocument(strDocumentReport), new DataSourceInfo(DataLayer.GetSingleCustomerDT(), "customer"));
						}
						catch (Exception ex)
						{
							Console.WriteLine(ex.Message);
					...
					else if (isDataSourceXML)
					{
						...
						try
						{
							...
							DocumentAssembler assembler = new DocumentAssembler();
							//Call AssembleDocument to generate Single Row Report in open document format
							assembler.AssembleDocument(CommonUtilities.GetSourceDocument(strDocumentTemplate), CommonUtilities.SetDestinationDocument(strDocumentReport), new DataSourceInfo(DataLayer.GetSingleCustomerXML(), "customer"));
						}
						catch (Exception ex)
						{
							Console.WriteLine(ex.Message);
					...
					else if (isJson)
					{
						...
						try
						{
							...
							DocumentAssembler assembler = new DocumentAssembler();//initialize object of DocumentAssembler class 
																				  //Call AssembleDocument to generate Single Row report in open document format
							assembler.AssembleDocument(CommonUtilities.GetSourceDocument(strDocumentTemplate), CommonUtilities.SetDestinationDocument(strDocumentReport), new DataSourceInfo(DataLayer.GetSingleCustomerDataJson(), "customer"));
						}
						catch (Exception ex)
						{
							Console.WriteLine(ex.Message);
				...
				case "spreadsheet":
					if (isDatabase)
					{
						...
						try
						{
							...
							assembler.AssembleDocument(CommonUtilities.GetSourceDocument(strSpreadsheetTemplate), CommonUtilities.SetDestinationDocument(strSpreadsheetReport), new DataSourceInfo(DataLayer.GetSingleCustomerDataDB(), "customer"));
						}
						catch (Exception ex)
						{
							Console.WriteLine(ex.Message);
					...
					else if (isDataSet)
					{
						...
						try
						{
							...
							DocumentAssembler assembler = new DocumentAssembler();
							//Call AssembleDocument to generate Single Row Report in open spreadsheet format
							assembler.AssembleDocument(CommonUtilities.GetSourceDocument(strSpreadsheetTemplate), CommonUtilities.SetDestinationDocument(strSpreadsheetReport), new DataSourceInfo(DataLayer.GetSingleCustomerDT(), "customer"));
						}
						catch (Exception ex)
						{
							Console.WriteLine(ex.Message);
					...
					else if (isDataSourceXML)
					{
						...
						try
						{
							...
							DocumentAssembler assembler = new DocumentAssembler();
							//Call AssembleDocument to generate Single Row Report in open spreadsheet format
							assembler.AssembleDocument(CommonUtilities.GetSourceDocument(strSpreadsheetTemplate), CommonUtilities.SetDestinationDocument(strSpreadsheetReport), new DataSourceInfo(DataLayer.GetSingleCustomerXML(), "customer"));
						}
						catch (Exception ex)
						{
							Console.WriteLine(ex.Message);
				...
				case "presentation":
					if (isDatabase)
					{
						...
						try
						{
							...
							assembler.AssembleDocument(CommonUtilities.GetSourceDocument(strPresentationTemplate), CommonUtilities.SetDestinationDocument(strPresentationReport), new DataSourceInfo(DataLayer.GetSingleCustomerDataDB(), "customer"));
						}
						catch (Exception ex)
						{
							Console.WriteLine(ex.Message);
					...
					else if (isDataSet)
					{
						...
						try
						{
							...
							DocumentAssembler assembler = new DocumentAssembler();
							//Call AssembleDocument to generate Single Row Report in open presentation format
							assembler.AssembleDocument(CommonUtilities.GetSourceDocument(strPresentationTemplate), CommonUtilities.SetDestinationDocument(strPresentationReport), new DataSourceInfo(DataLayer.GetSingleCustomerDT(), "customer"));
						}
						catch (Exception ex)
						{
							Console.WriteLine(ex.Message);
					...
					else if (isDataSourceXML)
					{
						...
						try
						{
							...
							DocumentAssembler assembler = new DocumentAssembler();
							//Call AssembleDocument to generate Single Row Report in open presentation format
							assembler.AssembleDocument(CommonUtilities.GetSourceDocument(strPresentationTemplate), CommonUtilities.SetDestinationDocument(strPresentationReport), new DataSourceInfo(DataLayer.GetSingleCustomerXML(), "customer"));
						}
						catch (Exception ex)
						{
							Console.WriteLine(ex.Message);
				...
				case "html":
					{
						...
						try
						{
							...
							assembler.AssembleDocument(CommonUtilities.GetSourceDocument(strHtmlTemplate), CommonUtilities.SetDestinationDocument(strHtmlReport), new DataSourceInfo(DataLayer.GetCustomerData(), "customer"));
						}
						catch (Exception ex)
						{
							Console.WriteLine(ex.Message);
				...
				case "text":
					{
						...
						try
						{
							...
							assembler.AssembleDocument(CommonUtilities.GetSourceDocument(strTextTemplate), CommonUtilities.SetDestinationDocument(strDocumentReport), new DataSourceInfo(DataLayer.GetCustomerData(), "customer"));
						}
						catch (Exception ex)
						{
							Console.WriteLine(ex.Message);
				...
				case "email":
					{
						...
						try
						{
							...
							var dataSources = DataLayer.EmailDataSourceObject(strEmailTemplate, DataLayer.GetCustomerData());
							var dataSourcesNames = DataLayer.EmailDataSourceName(".msg", "customer");
