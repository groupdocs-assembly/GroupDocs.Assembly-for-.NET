...
4.  Right click the chart and select 'Edit Data' to provide chart data. See [Chart Data (Excel)](https://docs.groupdocs.com/assembly/net/bubble-chart-in-word-processing-document/#adding-syntax-to-be-evaluated-by-groupdocsassembly-engine).
