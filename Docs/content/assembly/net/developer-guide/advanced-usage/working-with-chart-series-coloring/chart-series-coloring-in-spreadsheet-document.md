...
4.  Edit the Worksheet with your data to update the chart. See [Chart Data](https://docs.groupdocs.com/assembly/net/chart-series-coloring-in-spreadsheet-document/#adding-syntax-to-be-evaluated-by-groupdocsassembly-engine).
