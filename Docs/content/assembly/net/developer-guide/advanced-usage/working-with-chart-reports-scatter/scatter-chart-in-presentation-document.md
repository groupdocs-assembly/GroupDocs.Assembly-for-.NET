...
4.  Edit the Worksheet with your data to update the chart. See [Chart Data (Excel)](https://docs.groupdocs.com/assembly/net/scatter-chart-in-presentation-document/#adding-syntax-to-be-evaluated-by-groupdocsassembly-engine).
5.  Save the template.
...
{{< gist GroupDocsGists 3598ebdc3269aca6f2327a73bada7898 >}}



#### Database Entities

{{< gist GroupDocsGists f43af1740a91b064e0d3ceb1bcc73592 >}}



#### Using DataSet

{{< gist GroupDocsGists 540aac27ebff9a1951df05abe2be5b28 >}}



#### Using XML DataSource

{{< gist GroupDocsGists 6d9ea6c0d1c71305d1aee4f3832d89b8 >}}



#### Using JSON DataSource

{{< gist GroupDocsGists 0677d6be967163584f843189e5670b90 >}}
