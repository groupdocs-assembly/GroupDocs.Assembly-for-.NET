...
4.  Edit the Worksheet with your data to update the chart. See [Chart Data (Excel)](https://docs.groupdocs.com/assembly/net/pie-chart-in-word-processing-document/#adding-syntax-to-be-evaluated-by-groupdocsassembly-engine)
5.  Save the template.
...
{{< alert style="info" >}}See the video demonstration of Pie Chart in MS Word [here](https://www.youtube.com/watch?v=boKpFtW_TGE&list=PL25CTxMCj5vOzsaE9Rwjwd4-OwvdaWmJ8&index=13).{{< /alert >}}
