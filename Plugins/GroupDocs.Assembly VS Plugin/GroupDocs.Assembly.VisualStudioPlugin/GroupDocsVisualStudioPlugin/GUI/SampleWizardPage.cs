...
using GroupDocsAssemblyVisualStudioPlugin.Core;
using System.IO;
using System.Threading;
using System.Xml;
using GroupDocsAssemblyVisualStudioPlugin.XML;
using System.Xml.Serialization;
using System.Diagnostics;
using System.Xml.Linq;
using EnvDTE80;

namespace GroupDocsAssemblyVisualStudioPlugin.GUI
{
    public partial class SampleWizardPage : Form
    {
        ...
        bool CopyAndCreateProject()
        {
            ...
            //string sampleSourcePath = "GroupDocs.Assembly";
            ...
            try
            {
                ...
                string[] projectFiles = Directory.GetFiles(Path.Combine(destinationPath, (rdbCSharp.Checked ? "CSharp/GroupDocs.AssemblyExamples" : "VisualBasic/GroupDocs.Assembly.Examples")), (rdbCSharp.Checked ? "*.csproj" : "*.vbproj"));
